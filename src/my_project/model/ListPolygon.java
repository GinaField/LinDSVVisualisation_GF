...
public class ListPolygon extends GraphicalObject {
    ...
    private ListPolygon pointer;

    public ListPolygon (double x, double y, int r, int g, int b, ListPolygon previousListPolygon, boolean pointer, ViewController viewController){
        this.x = x;
        this.y = y;
        this.r = r;
        this.g = g;
